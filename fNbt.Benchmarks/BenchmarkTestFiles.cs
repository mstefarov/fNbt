...
public static class BenchmarkTestFiles {
    ...
    static NbtFile bigFile = null!;

    // Pre-Allocated Names And Values
    const int ComplexCompoundTagCount = 1000;
    static readonly string[] IntNames = new string[ComplexCompoundTagCount / 4];
    static readonly string[] StringNames = new string[ComplexCompoundTagCount / 4];
    static readonly string[] StringValues = new string[ComplexCompoundTagCount / 4];
    static readonly string[] ListNames = new string[ComplexCompoundTagCount / 4];
    static readonly string[] ByteArrayNames = new string[ComplexCompoundTagCount / 4];
